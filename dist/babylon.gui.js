...
QuickTreeGenerator = function(name,sizeBranch, sizeTrunk, radius, trunkMaterial, leafMaterial, scene) {
    
        var tree = new BABYLON.Mesh(name, scene);
